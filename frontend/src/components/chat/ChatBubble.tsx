...
function renderParsedContent(rawContent: string | ReactNode): ReactNode {
  ...
  lines.forEach((line) => {
    ...
    // Match [UI: PROGRESS | Title | Current | Target]
    ...
    // Default string fallback with line breaks
    nodes.push(
      <span key={keyCount}>
        {line}
        <br />
